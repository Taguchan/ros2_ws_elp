...
class EmotionRecognitionNode(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Image, 'camera/image_with_fer', 10)
        self.br = CvBridge()
    ...
    def listener_callback(self, data):
        ...
        for idx, face in enumerate(result_sorted):
            ...
            # 表情とスコアを表示
            cv2.putText(frame, f'ID: {face_id}, {emotion}: {score:.2f}', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 1)
